...
- Sister skills: `skills/signal-scorer/SKILL.md` (companion 6-dim signal scorer for granular grading), plus any downstream pipeline that consumes high-signal items
