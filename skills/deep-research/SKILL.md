...
## Optional: a citation verifier

Consider adding a citation-verifier script (one you provide) that programmatically resolves every cited URL and flags dead links. Until you wire one in, do the URL-resolve check manually as part of the quality gates.
