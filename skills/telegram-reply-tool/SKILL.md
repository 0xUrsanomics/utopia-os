...
The stop-hook (a reply-check script you provide) validates that every chat turn produced at least one successful reply call. Missing calls trigger a retry.
