...
- Sister skills: `skills/intel-analyzer/SKILL.md` (front-door analyzer that can invoke this skill for granular grading), plus any downstream pipeline that consumes scored signals for prioritization
