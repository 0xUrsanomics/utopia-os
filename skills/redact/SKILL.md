...
For now this skill is a behavior contract. when triggered, follow the workflow above using Read/Edit/Bash tools. A scripted implementation (a script you provide) is a future move if the skill gets invoked >5x and the manual flow gets repetitive.
