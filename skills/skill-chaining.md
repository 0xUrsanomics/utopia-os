...
- Sister skills: `skills/wave-plan.md` (DAG-based parallel-wave dispatch, different shape. chain is sequential, wave is parallel), `skills/agent-dispatch.md` (single-subagent dispatch primitive), `skills/scope.md` (precedes complex chains)
