...
- Sister skills: `skills/agent-dispatch.md` (sends individual subagent briefings within waves), `skills/scope.md` (precedes wave-plan when the ask is ambiguous), `skills-shared/subagent-delegation.md` (briefing template)
...
- **`/scope` (skills/scope.md)**: if the ask is CONFIRM-gate, /scope first to confirm the scope, THEN wave-plan the approved scope. Don't combine.
