...
- **Run via** (an optional skill-activity helper you provide):
  ```bash
  python3 scripts/skill_activity.py --tg     # one-line digest
  python3 scripts/skill_activity.py --summary  # full digest to stdout
  ```
...
- **Run via** (an optional dossier-hygiene helper you provide):
  ```bash
  python3 scripts/dossier_hygiene.py
  python3 scripts/dossier_hygiene.py --tg   # one-line digest
  ```
