...
- Downstream extractors (sister skills, examples — supply your own): a contact-extractor, a meeting-note-extractor, `skills-shared/task-extractor.md`, `skills/intel-analyzer.md`, a training-log-parser, a nutrition-log-parser, a CRM-memory operator
