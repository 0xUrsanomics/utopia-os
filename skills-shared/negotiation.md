...
- Sister skills: a pipeline-ops skill (qualification), an outreach-drafter (drafts the email side), `skills-shared/sycophancy-guard.md` (catches drift into compliance when pushback is correct)
