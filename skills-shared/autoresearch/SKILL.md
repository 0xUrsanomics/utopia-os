...
- `skills/loop-experiment/SKILL.md`. sister autoresearch pattern lift (from a public autoresearch sandbox pilot)
...
- `scripts/eval/skill_failure_tracker.py`. the failure ledger that feeds autoresearch's regression diagnosis
- `memory/Decisions.md`. past autoresearch ship decisions for calibration
- Sister skills: `skills/critic/SKILL.md` (the validated subagent that pairs well with autoresearch's diagnose step), `skills/save/SKILL.md` (captures insights from autoresearch runs)
