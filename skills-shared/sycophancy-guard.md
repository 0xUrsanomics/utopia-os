...
- Sister skills: `skills-shared/anti-ai-slop.md` (companion always-on inheritance), `skills/critic.md` (high-stakes review subagent)
- Auto-triggers `skills/decision-council.md` on detected drift
