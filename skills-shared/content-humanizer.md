...
- `skills-shared/anti-ai-slop.md` (the canonical AI-slop ruleset this skill enforces)
...
- `skills-shared/anti-ai-slop.md` v2 (the canonical detection list: rules + Prime Directive + grammar/structural tells)
...
The comprehensive detection list is `skills-shared/anti-ai-slop.md` (the canonical SoT: rules + Prime Directive on asymmetry + grammar/structural tells). Read it before auditing. The categories below are the humanizer's working subset.
...
| Humanity score | A manual pass against `skills-shared/anti-ai-slop.md` (the old scorer script was retired; the rule-based gate is the check now). **Ship threshold:** 0 critical 🔴 tells AND fewer than 3 🟡 per 500 words. Above that, it is a rewrite (Mode 2 full pass), not a ship. |
